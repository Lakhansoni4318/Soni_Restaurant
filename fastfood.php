    ...
    if (isset($_POST['addcart'])) {
        if (isset($_SESSION['cart'])) {
            ...
            if (in_array($_POST['Item_Name'], $myitem)) {
                ...
                window.location.href='fastfood.php';
                </script>";
            } else {
...
?>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./Image/fast food/images (10).jpeg" class="d-block w-100 opacity-50 img" alt="..."
                    height="400vh">
            ...
            <div class="carousel-item">
                <img src="./Image/fast food/images (9).jpeg" class="d-block w-100 opacity-50 img" alt="..."
                    height="400vh">
                <div class="carousel-caption text-center">
    ...
    <div class="row justify-content-around m-0">
        <div class="col-md-3 my-3 mx-5">
            <form action="fastfood.php" method="post">
                <div class="card card-inverse card-primary text-center">
                    <img class="card-img-top" src="./Image/fast food/fastfood1.jpeg" alt="Card image cap"
                        height="250px">
                    <div class="card-block">
                        <h4 class="card-title text-dark">Dabeli</h4>
                        <p class="card-text text-dark">20</p>
                        <?php
                    if($loggedin){
                echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
                    <input type="hidden" name="Item_Name" value="Dabeli"> 
        ...
        <form action="fastfood.php" method = "post">
            <div class="card card-inverse card-primary text-center">
                <img class="card-img-top" src="./Image/fast food/fastfood2.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">French Fries</h4>
        ...
        <form action="fastfood.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/fast food/fastfood3.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Panipuri</h4>
                    <<p class="card-text text-dark">20 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
                    <input type="hidden" name="Item_Name" value="Panipuri"> 
                    <input type="hidden" name="Price" value="20">';
                    }
                    else{
                        echo'<a href = "Login.php" class = "btn btn-info">Add to Cart</a>';
        ...
        <form action="fastfood.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/fast food/fastfood4.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Pizza</h4>
                    <p class="card-text text-dark">199 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
        ...
        <form action="fastfood.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/fast food/fastfood5.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Sandwich</h4>
        ...
        <form action="fastfood.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/fast food/fastfood6.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Taco</h4>
                    <p class="card-text text-dark">70 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
                    <input type="hidden" name="Item_Name" value="Taco"> 
                    <input type="hidden" name="Price" value="70">';
                    }
                    else{
                        echo'<a href = "Login.php" class = "btn btn-info">Add to Cart</a>';
