...
?>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./Image/breakfast/images (10).jpeg" class="d-block w-100 opacity-50" alt="..."
                    height="400vh">
            ...
            <div class="carousel-item">
                <img src="./Image/breakfast/images (9).jpeg" class="d-block w-100 opacity-50" alt="..."
                    height="400vh">
                <div class="carousel-caption text-center">
    ...
    <div class="row justify-content-around m-0">
        <div class="col-md-3 my-3 mx-5">
            <form action="breakfast.php" method="post">
                <div class="card card-inverse card-primary text-center">
                    <img class="card-img-top" src="./Image/breakfast/breakfast1.jpeg" alt="Card image cap"
                        height="250px">
                    <div class="card-block">
                        <h4 class="card-title text-dark">Aloo Paratha</h4>
        ...
        <form action="breakfast.php" method = "post">
            <div class="card card-inverse card-primary text-center">
                <img class="card-img-top" src="./Image/breakfast/breakfast2.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Dhokla</h4>
        ...
        <form action="breakfast.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/breakfast/breakfast3.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Masala Dosa</h4>
                    <p class="card-text text-dark">140 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
        ...
        <form action="breakfast.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/breakfast/breakfast4.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Sabudana Khichdi</h4>
                    <p class="card-text text-dark">60 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
                    <input type="hidden" name="Item_Name" value="Sabudana Khichdi"> 
        ...
        <form action="breakfast.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/breakfast/breakfast5.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
        ...
        <form action="breakfast.php" method = "post">
            <div class="card card-inverse card-success text-center">
                <img class="card-img-top" src="./Image/breakfast/breakfast6.jpeg" alt="Card image cap" height="250px">
                <div class="card-block">
                    <h4 class="card-title text-dark">Tarri Batata Pohe</h4>
                    <p class="card-text text-dark">40 Rs</p>';
                    if($loggedin){
                    echo'<button type = "submit" class = "btn btn-info" name="addcart">Add to Cart</button>
                    <input type="hidden" name="Item_Name" value="Tarri Batata Pohe"> 
                    <input type="hidden" name="Price" value="40">';
                    }
                    else{
                        echo'<a href = "Login.php" class = "btn btn-info">Add to Cart</a>';
